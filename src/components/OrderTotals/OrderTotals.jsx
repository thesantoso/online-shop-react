    ...
    return (
        <div className={styles.orderTotals}>
            ...
            <div className={styles.totalsContainer}>
                ...
                <p className={styles.totalsPrices}><span>Subtotal:</span><span>Rp. {subTotal}</span></p>
                <p className={styles.totalsPrices}><span>Discount:</span><span>{discount ? discount : '0'}%</span></p>
                <p className={styles.totalsPrices}><span className={styles.orderTotalPrice}>Order total:</span><span className={styles.totalPrice}>Rp. {total}</span></p>
            </div>
        </div>
    );
};
